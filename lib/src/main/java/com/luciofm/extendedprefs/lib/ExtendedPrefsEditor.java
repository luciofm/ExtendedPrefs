...
public class ExtendedPrefsEditor {
    ...
    public ExtendedPrefsEditor putStringSet(String key, Set<String> value) {
        if (PlatformSpecificImplementationFactory.SUPPORTS_HONEYCOMB)
		    mEditor.putStringSet(key, value);
        else
            supportPutStringSet(key, value);
		return this;
	}

    private void supportPutStringSet(String key, Set<String> value) {
        Type type = new TypeToken<Set<String>>(){}.getType();
        putData(key, type, value);
    }
